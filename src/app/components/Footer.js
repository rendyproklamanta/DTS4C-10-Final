         ...
         <Container fluid className='bg-light' style={{ bottom: 0, position: 'absolute' }}>
            <div className="container-fluid py-4 px-sm-3 px-md-5">
               <p className="m-0 text-center">
                  ...
                  All Rights Reserved. Created By <a className="font-weight-bold" target="_blank" rel="noreferrer" href="https://github.com/rendyproklamanta/DTS4C-10-Final">REA4C-10</a>
               </p>
            </div>
         </Container>
      </>
